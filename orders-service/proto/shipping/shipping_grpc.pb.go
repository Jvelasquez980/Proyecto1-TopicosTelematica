...
type ShippingServiceClient interface {
	CreateShipment(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error)
}
...
func (c *shippingServiceClient) CreateShipment(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error) {
...
type ShippingServiceServer interface {
	CreateShipment(context.Context, *ShippingRequest) (*ShippingResponse, error)
...
func (UnimplementedShippingServiceServer) CreateShipment(context.Context, *ShippingRequest) (*ShippingResponse, error) {
...
func _ShippingService_CreateShipment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).CreateShipment(ctx, req.(*ShippingRequest))
	}
